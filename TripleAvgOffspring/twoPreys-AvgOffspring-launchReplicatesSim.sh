...
#     prd_oprt_1=${oprtArray[$i]} 
    ...
    do
        pry_offs_1=`echo "scale=0; ${ratioArray[$k]}" | bc`;
        pry_offs_2=$pry_offs_1

        echo " Prey1 and 2 average offspring nb : ${ratioArray[$k]}"

        # name the simulation with only the variables of interest and their value
        sim_name="doubleCatchProba-twoPreys-pryOffs${ratioArray[$k]}" # argv[1]
