...
# sim values arrays
prey1init=(0 100)
ctchProbaArray=(0.1 0.2 0.3 0.4)
...
do 
    ...
    do
        ...
        do
            ...
            # name the simulation with only the variables of interest and their value
            sim_name="calibProbSurv-py1Init$pry_init_1-prdCtPr$prd_ctch_pry1_1-prdCvRt$prd_cvrt_pry1_1" # argv[1]
